...
from efficientnet_pytorch import EfficientNet, EfficientNetBW
import wandb
...
config_defaults = {'global_seed':42,
                   'wandb':{'mode':'online',
                    ...
                    'dataset':{ 'data_dir':'/datasets/vision/tiny-imagenet-200',
                                ...
                                'val_split':0.2},
                    'model':{ 'name':'efficientnet-b0', 'load_pretrained':False, 'num_classes':200,'dropout_rate':0.5},
